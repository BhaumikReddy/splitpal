  ...
  return (
    <div className="space-y-4 mt-4">
      {splits.map((split) => (
        <div
          key={split.userId}
          className="flex items-center justify-between gap-4 p-3 bg-gray-900/50 rounded-lg border border-gray-700"
        >
            ...
            <div className="flex items-center gap-4 flex-1">
              ...
              <div className="flex gap-1 items-center min-w-[100px]">
                <Input
                  ...
                  className="w-16 h-8 bg-gray-800 border-gray-600 text-white"
                />
                <span className="text-sm text-gray-400">%</span>
                <span className="text-sm ml-1 text-gray-300">${split.amount.toFixed(2)}</span>
              </div>
            </div>
          )}
      ...
      {/* Total row */}
      <div className="flex justify-between border-t border-gray-600 pt-4 mt-4 bg-gray-900/30 rounded-lg p-3">
      ...
      {type === "percentage" && !isPercentageValid && (
        <div className="text-sm text-amber-400 mt-2 p-2 bg-amber-500/10 border border-amber-500/20 rounded">
